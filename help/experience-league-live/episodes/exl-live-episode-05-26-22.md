...
在有关Adobe Experience Cloud数据收集的三场直播研讨会的第一场中，了解通过Web SDK进行Web数据收集的“现在就是未来”。 我们将向您展示Web SDK的所有基础知识，包括它背后的推理、它的工作方式以及它支持的重要用例。 我们将会有专家来了解它，因此我们能够回答问题并展示最佳实践。

>[!VIDEO](https://video.tv.adobe.com/v/343335/?quality=12&learn=on)

**在** Experience League社区[中继续讨论](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-platform-launch/experience-league-live-post-session-discussion-the-basics-of-web/m-p/454159#M283){target="_blank"}！

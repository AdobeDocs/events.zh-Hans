...
随着品牌超越单向、单渠道的消息传递，探索客户参与的新界面和使用案例。 了解营销和产品团队如何创建更可见、情境式和持续的体验 — 推动跨渠道持续参与和更丰富的实时互动。
<br>
</br>
...
我们将探索使用Adobe Journey Optimizer的组织如何通过iOS实时活动、Web推送通知和消息收件箱扩展其客户参与策略。 这些新的渠道和功能加在一起，使团队能够提供实时更新，将参与扩展到移动应用程序之外，并确保重要消息始终可用，从而创建更一致、以客户为中心的历程。

我们将涵盖：

- iOS Live活动：在iPhone锁屏界面和Dynamic Island上提供实时更新，以便获取订单跟踪、航班状态和实时得分等高价值时刻，从而随着事件的发生不断让客户了解最新信息。

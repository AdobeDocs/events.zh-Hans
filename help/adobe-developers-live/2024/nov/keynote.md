...
description: Adobe强调开发人员在其Experience Manager和Commerce业务中的关键作用，强调混合事件格式，庆祝里程碑，并专注于创新、性能、社区参与以及Web性能、创作UI和高级搜索功能的未来发展。
...
首先是Adobe战略和产品副总裁Loni Stark向高管致以欢迎之辞，为这一天做好了准备。 然后，与Adobe Experience Manager产品管理总监Cedric Huesler一起分享Adobe的数字体验愿景。 探索推动Adobe Experience Manager前进的最新创新、这些创新对Web开发的影响，并预览即将推出的功能。
...
* **开发人员的重要性**&#x200B;开发人员对于Adobe及其Experience Manager和Adobe Commerce业务至关重要。  
* **混合格式**&#x200B;该事件具有特殊性，因为它将现场和在线格式相结合，以增进联系。
* **里程碑成就** Adobe Experience Manager已成为Adobe数字体验业务的基石。  
...
* **创作UI和Personalization**&#x200B;未来Web体验将涉及基于实时数据和用户交互的创作UI组合和个性化内容交付。  
* **搜索和索引** Adobe正在实现高级搜索功能，包括矢量索引，以改善内容检索和用户体验。

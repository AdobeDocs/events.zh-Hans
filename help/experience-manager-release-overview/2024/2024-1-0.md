...
description: 此版本中的功能主要针对Experience Manager Assets和Cloud Service创新，包括以下内容：AEM Assets：AEM AssetsCloud Service与Adobe Journey Optimizer集成智能标记阻止列表OOTB视频预览呈现版本Cloud Manager：自定义权限

...
description: 通过自动执行日常任务（如直接在Salesforce中准备数据驱动型文档），在几秒钟内即可让您的销售团队掌握预先填充的提案、合同、发票等信息。 Document Builder允许您在发送签名之前使用Salesforce数据动态生成文档，使曾经繁琐的流程变得更加简单和简化。
...
它允许用户在发送文档供签名之前动态生成文档，无需手动输入、复制和粘贴。 借助Document Builder，用户可以使用Microsoft Word插件在Adobe Word中创建模板、从Salesforce映射数据字段并生成包含预填充数据的文档。
...
* 单击“允许访问”将Salesforce与Adobe Acrobat Sign连接。

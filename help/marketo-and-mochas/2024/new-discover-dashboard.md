...
与Adobe的高级业务顾问Kate Colbert和技术顾问James Leedom一起探讨9个现在可供所有Marketo Measure实例使用的新Discover功能板。 这些新发布的功能板通过重要指标（如收入、归因收入、ROI、参与度、潜在客户周转率、机会周转率和Web流量）提供动态视角和增强见解。 数据驱动型洞察对于优化参与策略以及提升增长和转化率至关重要。
...
* Data Warehouse选项提供了更高级的数据分析和可视化功能。

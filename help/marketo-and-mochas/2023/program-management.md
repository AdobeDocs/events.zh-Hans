...
程序是Marketo中最重要的元素之一。 无论您是设置文件夹、使用命名约定、搜索成员、检查程序状态还是只对管理最佳实践感兴趣，此事件均适合您。 在本次大会上，Marketo &amp; Mochas、Adobe业务顾问、Cynthia Chang和Kate Colbert介绍了对“计划库”模板和创意资源的最新更新，以及分享计划管理最佳实践和演示。

---
title: Acrobat Analyzer简介
description: 探索Adobe Acrobat Analyzer，它是一款适用于Acrobat Sign的GenAI工具，可自动执行文档工作流、降低风险并提高决策效率。
...
* Acrobat Analyzer简介
* 如何使用Acrobat Analyzer自动审查数千个文档并加快跨业务职能部门的文档工作流
* 如何在您的Acrobat Sign帐户中启用它

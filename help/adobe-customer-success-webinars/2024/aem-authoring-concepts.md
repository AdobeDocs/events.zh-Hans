...
认识到扩展内容生成所面临的挑战，例如对内容需求的增长、全渠道内容交付的需求以及提高内容投资回报的重要性。  

### 创作功能

AEM中的各种创作工具概述，

* **页面编辑器**&#x200B;用于创建和编辑网页的传统WYSIWYG编辑器。  
* **内容片段编辑器**，用于创建可跨不同渠道重复使用的Headless内容。  
* **通用编辑器**&#x200B;用于内容创建的现代UI，它支持AEM内容和正确检测的外部内容。  
* **基于文档的创作**&#x200B;允许使用熟悉的工具（如Microsoft Word或Google Docs）创建内容，这些工具与AEM工作流集成。  

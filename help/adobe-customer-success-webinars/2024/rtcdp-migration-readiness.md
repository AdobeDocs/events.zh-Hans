...
description: 了解如何迁移到Adobe Real-time CDP (RTCDP)以及需要的工作量： — 从现有CDP迁移 — 对现有用例的影响（Personalization和优化） — 支持实时客户数据管理所需的组织更改。
...
了解如何迁移到Adobe Real-time Customer Data Platform以及需要的工作量，
...
* 该会议讨论了从Adobe Audience Manager等现有CDP演变到Adobe的Real-time CDP等Real-time CDP以适应行业趋势并为未来数据管理需求做准备的重要性。

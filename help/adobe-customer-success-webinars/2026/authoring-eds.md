---
title: 在Edge Delivery Services中创作
...
在这场中午风格的对决中，您将看到基于文档的创作和通用编辑与AEM Sites在Edge Delivery Services前沿的对手枪手对决 — 他们都在努力证明这是创造体验的最快速和最强大的方式。 通过实时比较和实际情景，您将看到每种方法具体在何处闪现、在何处不能发挥效果，以及它如何影响您的团队、治理和上市速度。 当尘埃落定时，县长（文档创作）赶来将秩序带入混乱之中，向客户展示了如何将各种方法结合到一个现代、经得起未来考验的创作策略中。

>[!VIDEO](https://video.tv.adobe.com/v/3479916/?learn=on&enablevpops)

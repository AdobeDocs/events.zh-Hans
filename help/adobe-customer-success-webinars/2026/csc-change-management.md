...
* **重新设计团队如何协作**&#x200B;了解如何通过明确的角色、标准工作流以及数据和人工智能的实用护栏，打破营销、创意、运营和IT之间的孤立关系 — 以便人们确切了解其日常工作如何在规划、创建、激活和衡量过程中发生变化。

* **通过流动的数据模型提高响应速度**&#x200B;了解更改管理原则如何支持从静态的孤立操作向自适应、有效的协作转变，具体方法是：采用有效的工作流，在重要时刻启用动态参与，以及释放团队的完整潜力。

---
title: 使用Workfront展示板的3大理由
description: 了解Workfront展示板如何通过简单的设置、模板和跟踪来提高用户采用率。 毫不费力地让您的团队参与进来。
...
又是我，你的“On-Demand Workfront CSM”Cynthia Boon和另一段“Top 3”视频！

我们来谈谈收养吧！ 我们正在寻找关于如何让新用户兴奋地登录到Workfront的新想法，那么为什么不考虑使用展示板？
...
* [Adobe Workfront中的讨论区入门](https://experienceleague.adobe.com/docs/workfront/using/agile/boards-in-workfront/get-started-with-boards.html?lang=zh-Hans)
* [Adobe Workfront展示板的早期功能加入](https://experienceleague.adobe.com/docs/workfront/using/agile/boards-in-workfront/boards-early-feature-opt-in.html?lang=zh-Hans)

...
该会议由Adobe Professional Services的Steve Watts和Brian Haight联合主持，将介绍读取JSON路径表示法、了解数据类型以及在Fusion中选择正确起始路径的基础知识。

此外，还介绍了三个真实示例，包括查找和过滤数据、重塑JSON以及动态执行高级转换。 对于任何希望节省时间和简化数据处理的Fusion管理员而言，这是一项必不可少的技能！

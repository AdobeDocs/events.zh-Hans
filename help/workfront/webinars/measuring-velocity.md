...
了解如何使用测量和跟踪速度 [!DNL Workfront] 报表。 该研讨会于2019年8月14日录制。
...
可以，您可以输入可能能够找到的任何RGB代码。 这是一个标准代码，用于表示颜色中包含的红色、绿色和蓝色数量。 Workfront将接受从000000到FFFFFF的任何十六进制值，因此如果您知道品牌颜色的代码，则可以使用该代码。
...
在报表中，为什么值可用作列，但不能用于选择或分组。 例如：问题源。

...
+ 车间倒带 {#workshop-rewind}
   ...
   + 工作流 {#workflow}
      ...
      + [增强的自定义Forms和本地化](workshop-rewind/workflow/enhanced-logic-localization.md)
      + [管理、执行和采用提示](workshop-rewind/workflow/governance-execution-adoption.md)
      + [群组管理要点](workshop-rewind/workflow/group-admins.md)
      + [高级企业运营简介](workshop-rewind/workflow/intro-aeo.md)
      ...
      + [一个团队](workshop-rewind/workflow/team-of-one.md)
      ...
      + [跟踪您的Sys管理员值](workshop-rewind/workflow/system-admin-value.md)
      ...
      + [Workfront管理员 — 10堂课](workshop-rewind/workflow/workfront-admin-10-lessons.md)
...
+ 快速获取 {#quicktakes}
   ...
   + 对比！ {#versus}
      ...
      + [问题与项目](quick-takes/versus/issues-vs-projects.md)

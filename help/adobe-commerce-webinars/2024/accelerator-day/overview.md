...
2024年5月7日，Adobe与澳大利亚联邦银行合作，在澳大利亚联邦银行的悉尼礼堂招待了客户和合作伙伴。 该活动是围绕Adobe Commerce、Adobe Experience Cloud和英联邦银行关于PowerBoard支付协调平台最新支付开发的一整天创新会议。
...
| **体验演变：Commerce、数据和您** | 使用[!DNL Real-Time Customer Data Platform]、[!DNL Journey orchestration]和集成的Adobe [!DNL Experience Platform]的Commerce个性化概述和演示 | <ul><li>Mike Lynch - Adobe企业[!DNL Commerce]专家</li></ul> | [观看视频](./experience-evolution.md) |
...
| **新一代Commerce：新一代AI应用程序的兴起** | Commerce中的AI概述和演示，Adobe通过[!DNL Adobe Express]的最新创作AI，以及如何在现实世界中将其用于商业和内容团队。 | <ul><li>Eroka O&#39;Connor - Adobe高级解决方案顾问</li></ul> | [观看视频](./next-gen-commerce.md) |
...
| **闪电速度：Adobe的边缘交付服务** | 关于Adobe通过Adobe Experience Manager和Adobe Commerce实现闪电般快速的Edge Delivery Services的最新详细信息和演示 | <ul><li>Kam Radhakrishnan - Adobe高级解决方案工程师</li></ul> | [观看视频](./lightning-speed.md) |
| **可组合性：App Builder、API Mesh和Headless** | 概述Adobe Commerce和App Builder平台的最新发展，通过无头、可组合的创新实现数字体验的可扩展性 | <ul><li>Jason Ford - Adobe澳新银行解决方案工程总监</li></ul> | [观看视频](./composability.md) |
| **跨渠道交响乐：编排Commerce卓越** | 由Adobe的Matt Palmer主持的壁炉边聊天，探讨DotDigital如何与Adobe Commerce合作推动创新、个性化和一对一消息传递 | <ul><li> Matt Palmer - Adobe高级合作伙伴销售经理</li><li>Graham Bell - DotDigital澳新银行销售总监</li></ul> | [观看视频](./cross-channel-symphony.md) |
| **Commerce的艺术** | 在Adobe Commerce上展示实时客户示例，以解决方案合作伙伴的创新走在最前面，展示最前沿的功能 | <ul><li>Carl Screwvala - Adobe高级解决方案工程师</li></ul> | [观看视频](./the-art-of-commerce.md) |

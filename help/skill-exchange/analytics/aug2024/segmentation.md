---
title: 构建基块 — 深入了解区段
description: Adobe Analytics中的区段可能非常强大，但凭借这种力量，会带来复杂性和细微差别，从而大幅改变返回的数据。 就连经验丰富的分析师也会对某些逻辑的运作方式感到困惑。 此会话将深入分析范围（在区段和容器级别）、排除逻辑与“不等于/包含”有何不同以及为什么不同，并消除一些常见的误解，这些误解将允许您提升区段级别。关键学习包括区段范围注意事项 — 排除逻辑的强大功能 — 选择正确的配置以取得成功
solution: Analytics

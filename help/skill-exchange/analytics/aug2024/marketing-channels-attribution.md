...
* 配置Adobe Analytics：获取有关设置促销活动跟踪代码、捕获相关数据和利用Adobe Launch高效收集数据的实用知识。

  要下载此会话中介绍的促销活动跟踪代码生成器工具，请在Experience League的视角中访问[掌握Adobe Analytics营销渠道和归因](https://experienceleague.adobe.com/zh-hans/perspectives/mastering-adobe-analytics-marketing-channels-attribution)。

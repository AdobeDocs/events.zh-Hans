---
title: 带有Analysis Workspace的数据Storytelling
...
# 带有Analysis Workspace的数据Storytelling
...
## 解锁有影响力的数据Storytelling

了解如何超越传统的报告功能，创建可推动利益相关者采取实际行动的功能板。

* **Storytelling推动行动**&#x200B;利益相关者响应insight、紧迫性和情感相关性，而不仅仅是原始数据。
* **叙述性结构很重要**&#x200B;使用设置、张力和分辨率引导用户浏览您的仪表板，镜像有效的storytelling。
